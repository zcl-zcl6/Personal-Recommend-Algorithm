...
if __name__ == "__main__":
    # item_dict = get_item_info(r"F:\Pycharm\data\movies.txt")
    # print(len(item_dict))
    # print(item_dict["11"])
    # ave_score = get_ave_score(r"F:\Pycharm\data\ratings.txt")
    # print (len(ave_score))
    # print(ave_score["31"])
    train_data = get_train_data(r"F:\Pycharm\data\ratings.txt")
